      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-[2rem] md:text-[3rem] xl:text-[4rem] font-bold mb-6 text-gray-900 dark:text-white">
            Возможности <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Maetry</span>
          </h2>
          <p className="text-[1.2rem] md:text-[1.5rem] text-gray-600 dark:text-gray-300 max-w-4xl mx-auto">
            Каждый блок показывает проблему, решение и ценность для салона красоты
          </p>
        </div>
